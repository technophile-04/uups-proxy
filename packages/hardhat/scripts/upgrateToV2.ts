...
async function main() {
  ...
  // transferOwership to my Frontend address
  await upgradedContract.transferOwnership("0xF37dB18dA71970FeE6242EdFF9cb5C841D68F117");

  console.log(`YourContractProxy is now pointing to implementation deployed to: ${newImplementationAddress}`);
  ...
  if (chainId !== "31337") {
    ...
    console.log("YourContract_ImplementationV2 Proxy verified on Etherscan.");
  }
}
